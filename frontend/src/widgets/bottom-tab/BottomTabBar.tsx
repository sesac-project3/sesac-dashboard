...
// 시각 규칙(각짐 없는 radius 없음, active=indigo, inactive=gray)은 그대로 적용.
// 높이는 AppHeader와 동일한 56px(h-14)로 맞춘다 — 상/하단 바 크기 통일.
const TABS = [
...
export default function BottomTabBar() {
  ...
  return (
    <nav
      className="flex h-14 shrink-0 border-t border-border bg-white"
