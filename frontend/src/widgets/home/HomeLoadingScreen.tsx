...
// (MarketDashboard의 `!data && !error` 상태). 이후 5초 주기 자동 갱신/새로고침 때는
// data가 이미 있어서 이 화면이 다시 뜨지 않는다.
    ...
    <div className="flex h-full w-full flex-col items-center justify-between px-6 py-12">
      ...
      <div className="flex flex-col items-center gap-8">
        ...
        <img
          ...
          alt="Z-STOCK"
          className="animate-float w-40 max-w-[60vw] select-none drop-shadow-[0_10px_24px_rgba(84,43,233,0.25)]"
        />
